...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div>
            <h1 class="h3 mb-0 text-gray-800">Detail Peminjaman Ruang {{$detail->getBarang->nama}}</h1>
            <a href="{{route('admin.ruang')}}"><i class="fa fa-caret-left"></i> Kembali ke daftar peminjaman </a>
        </div>
        @php
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <table class="table table-bordered" width="100%" cellspacing="0">
                        ...
                        <tr>
                            <th>Bentuk Meja</th>
                            <td>{{$detail->bentuk_meja}}</td>
                        </tr>
                        <tr>
                            <th>Custom Request</th>
                            <td>{{$detail->custom_request}}</td>
                        </tr>
                    </table>
                </div>
            </div>
                <div class="row">
                    <div class="col-md-12 text-center">
                        <div class="btn-group">
                            <button href="{{route('admin.ruang.approval',['id' => encrypt($detail->id),
