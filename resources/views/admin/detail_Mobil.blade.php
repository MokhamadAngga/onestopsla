...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div>
            <h1 class="h3 mb-0 text-gray-800">Detail Peminjaman {{$detail->getBarang->nama}}</h1>
            <a href="{{route('admin.mobil')}}"><i class="fa fa-caret-left"></i> Kembali ke daftar peminjaman </a>
        </div>
        @php
        ...
        <div class="card-body">
                ...
                <div class="col-md-6">
                    <table class="table table-bordered" width="100%" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td>{{$detail->keterangan_penggunaan}}</td>
                        </tr>
                        <tr>
                            <th>Jumlah Orang</th>
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <div class="btn-group">
                        <button href="{{route('admin.mobil.approval',['id' => encrypt($detail->id),
